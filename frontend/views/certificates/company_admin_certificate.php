                            ...
                            <div class="row">
                                <div class="col-md-12" style="overflow-x: auto;">
                                    <div class="row">
                                        ...
                                        <div class=" col-md-3">                                                                                                                                <div class="input-append btn-group">
    <input class="span2" id="search-criteria" size="16" type="text" placeholder="Search">
    <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
        <span class="caret"></span>
    </a>
    <ul class="dropdown-menu">
        <?php foreach ($out4 as $value) { ?>
        <li><a href="#"><i class="icon-pencil"></i><?= $value;?></a></li>
        <?php } ?>
    </ul>
</div>
                                        </div>
                                   ...
                                   <table class="table table-striped table-no-bordered table-hover dataTable dtr-inline">
                                                    ...
                                                    <tbody>
                                                        <?php if (!empty($out3) || !empty($data1)) { ?>
                                                        <?php foreach ($out3 as $value) {
                                             ...
                                             $branch= Branches::findOne(['id'=>$branch_id])->branch_name;
                                                            ...
                                                            <tr>                                                                
                                                               <td><?= $i ?></td>
                                                                ...
                                                                <td><div id="DateCountdown" data-date="2019-01-01 00:00:00" style="width: 100px; height: 100px; padding: 0px; box-sizing: border-box;"></div></td>
                                                        <script> $("#DateCountdown").TimeCircles({time: {Hours: {show: false}, Minutes: {show: false}, Seconds: {show: false}}});
