...
class Learners extends \yii\db\ActiveRecord {
 ...
 public $role;
    ...
    public function rules() {
        return [
                [['user_id', 'address_id', 'designation','role', 'status', 'created_by', 'updated_at', 'updated_by'], 'required'],
                [['user_id', 'address_id', 'payment_type', 'status','role', 'created_by', 'updated_by'], 'integer'],
